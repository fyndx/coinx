...
INSERT INTO `__new_coinx_store`("id", "name", "location", "created_at", "updated_at") SELECT "id", "name", "location", "created_at", "updated_at" FROM `coinx_store`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_coinx_category`("id", "name", "icon", "color", "type", "created_at", "updated_at") SELECT "id", "name", "icon", "color", "type", "created_at", "updated_at" FROM `coinx_category`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_coinx_product_listing`("id", "product_id", "name", "store_id", "url", "price", "quantity", "unit", "created_at", "updated_at") SELECT "id", "product_id", "name", "store_id", "url", "price", "quantity", "unit", "created_at", "updated_at" FROM `coinx_product_listing`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_coinx_product_listing_history`("id", "product_id", "product_listing_id", "price", "recorded_at") SELECT "id", "product_id", "product_listing_id", "price", "recorded_at" FROM `coinx_product_listing_history`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_coinx_product`("id", "name", "image", "notes", "default_unit_category", "created_at") SELECT "id", "name", "image", "notes", "default_unit_category", "created_at" FROM `coinx_product`;--> statement-breakpoint
